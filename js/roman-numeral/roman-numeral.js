var RomanNumeral = (function (){
	...
	RomanNumeral.prototype.set = function (newNumeral){
		value = newNumeral;
	};

	RomanNumeral.prototype.get = function (){
		return value;
	};

	RomanNumeral.prototype.setFromNumber = function (newNumber){
		value = '';
		var remainder = newNumber;
		var numeralKeys = Object.keys(numeral_enum);
		//Keys auto sort to lowest value
		var pointer = numeralKeys.length-1;
	...
	RomanNumeral.prototype.toNumber = function (){
		var count = 0;
